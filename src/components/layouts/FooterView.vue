  ...
  <div>
    <div class="bg-white-300 pt-44 pb-24">
      <div
        ...
        <div class="row-span-2 sm:col-span-4 col-start-1 col-end-4 sm:col-end-5 flex flex-col items-start "><svg
            class="h-8 w-auto mb-6" width="149" height="37" viewBox="0 0 149 37" fill="none"
          ...
          <p class="mb-4"><strong class="font-medium">LaslesVPN</strong> is a private virtual network that has unique
            features and has high security.</p>
          <div class="flex w-full mt-2 mb-8 -mx-2">
            <div class="mx-2 bg-white-500 rounded-full items-center justify-center flex p-2 shadow-md"><svg
                class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
                <path fill="none" d="M0 0h24v24H0z"></path>
                <path
                  d="M14 13.5h2.5l1-4H14v-2c0-1.03 0-2 2-2h1.5V2.14c-.326-.043-1.557-.14-2.857-.14C11.928 2 10 3.657 10 6.7v2.8H7v4h3V22h4v-8.5z"
                  fill="rgba(245,56,56,1)"></path>
              </svg></div>
            <div class="mx-2 bg-white-500 rounded-full items-center justify-center flex p-2 shadow-md"><svg
                class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
                <path fill="none" d="M0 0h24v24H0z"></path>
        ...
        <div class=" row-span-2 sm:col-span-2 sm:col-start-7 sm:col-end-9 flex flex-col">
          ...
          <ul class="text-black-500 ">
            <li class="my-2 hover:text-orange-500 cursor-pointer transition-all">Download
              <!-- -->
            </li>
            <li class="my-2 hover:text-orange-500 cursor-pointer transition-all">Pricing
              <!-- -->
            </li>
            <li class="my-2 hover:text-orange-500 cursor-pointer transition-all">Locations
              <!-- -->
            </li>
            <li class="my-2 hover:text-orange-500 cursor-pointer transition-all">Server
              <!-- -->
            </li>
            <li class="my-2 hover:text-orange-500 cursor-pointer transition-all">Countries
              <!-- -->
            </li>
            <li class="my-2 hover:text-orange-500 cursor-pointer transition-all">Blog
              <!-- -->
            </li>
          </ul>
        </div>
        <div class="row-span-2 sm:col-span-2 sm:col-start-9 sm:col-end-11 flex flex-col">
          ...
          <ul class="text-black-500">
            <li class="my-2 hover:text-orange-500 cursor-pointer transition-all">LaslesVPN ?
              <!-- -->
            </li>
            <li class="my-2 hover:text-orange-500 cursor-pointer transition-all">FAQ
              <!-- -->
            </li>
            <li class="my-2 hover:text-orange-500 cursor-pointer transition-all">Tutorials
              <!-- -->
            </li>
            <li class="my-2 hover:text-orange-500 cursor-pointer transition-all">About Us
              <!-- -->
            </li>
            <li class="my-2 hover:text-orange-500 cursor-pointer transition-all">Privacy Policy
              <!-- -->
            </li>
            <li class="my-2 hover:text-orange-500 cursor-pointer transition-all">Terms of Service
              <!-- -->
            </li>
          </ul>
        </div>
        <div class="row-span-2 sm:col-span-2 sm:col-start-11 sm:col-end-13 flex flex-col">
          ...
          <ul class="text-black-500">
            <li class="my-2 hover:text-orange-500 cursor-pointer transition-all">Affiliate
              <!-- -->
            </li>
            <li class="my-2 hover:text-orange-500 cursor-pointer transition-all">Become Partner
              <!-- -->
            </li>
          </ul>
        </div>
